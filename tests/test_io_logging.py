"""
Tests for LLM I/O logging functionality.

These tests verify that the io_logging module correctly writes request/response
payloads to log files when UNILLM_IO_LOG is enabled.
"""
